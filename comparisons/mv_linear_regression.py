...
if __name__ == '__main__':
    ...
    # create models
    pagnn = PAGNN(D + 5, D, 1, initial_sparsity=0.9) # graph_generator=nx.generators.classic.complete_graph)
    print(pagnn)
    ...
    fig.suptitle('Multi-Variate Linear Regression - (PAGNN vs torch.nn.Linear)', fontsize=24)
    ...
    plt.savefig('figures/mv_linear_regression.png', transparent=True)
    plt.show()
