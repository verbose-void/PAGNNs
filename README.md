...
- **TL;DR**: A PAGNN gets it's nonlinearity from the direct & indirect recurrency in it's topology. This means that **PAGNNs have the capacity to learn their own "activation" function**.
